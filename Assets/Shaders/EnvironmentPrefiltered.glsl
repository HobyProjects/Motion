...
// ----------------------------------------------------------------------------
float DistributionGGX(vec3 N, vec3 H, float u_PrefilteredRoughness)
{
    float a = u_PrefilteredRoughness*u_PrefilteredRoughness;
    float a2 = a*a;
...
// ----------------------------------------------------------------------------
vec3 ImportanceSampleGGX(vec2 Xi, vec3 N, float u_PrefilteredRoughness)
{
	float a = u_PrefilteredRoughness*u_PrefilteredRoughness;
...
{		
    ...
    for(uint i = 0u; i < SAMPLE_COUNT; ++i)
    {
        ...
        if(NdotL > 0.0)
        {
            // sample from the environment's mip level based on u_PrefilteredRoughness/pdf
